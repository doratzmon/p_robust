...
namespace CPF_experiment
{
    public class DynamicLazyOpenList : OpenList//<WorldState>
    {
        ...
        public override IBinaryHeapItem Remove()
        {
            ...
            if (this.user is P_Robust_Optimal_ClassicAStar) // HACK!! Just until I copy this method to the interface and implement it everywhere.
                branchingFactor = ((P_Robust_Optimal_ClassicAStar)this.user).GetEffectiveBranchingFactor();
