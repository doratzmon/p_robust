...
namespace CPF_experiment
{
    ...
    class CostTreeSearchSolver : ICbsSolver
    {
        ...
        public virtual void Setup(ProblemInstance problemInstance, int minDepth, Run runner, int minCost = -1)
        {
            ...
            if (problemInstance.parameters.ContainsKey(P_Robust_Optimal_CBS_LocalConflicts.CAT))
            {
                CBS_CAT = ((Dictionary<TimedMove, List<int>>)problemInstance.parameters[P_Robust_Optimal_CBS_LocalConflicts.CAT]);
            }
        }
